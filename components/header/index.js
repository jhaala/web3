    ...
    <header class="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
      <div class="flex items-center px-6 py-6 xl:px-24">
        ...
        <a href="/" class="shrink-0">
          <img src="img/logo.png" class="max-h-7 dark:hidden" alt="" />
          <img
        ...
        {/* <!-- Menu / Actions --> */}
        <div class="js-mobile-menu invisible fixed inset-0 z-10 ml-auto items-center bg-white opacity-0 dark:bg-jacarta-800 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
          ...
          <div class="ml-8 hidden lg:flex xl:ml-12">
            ...
            <a
              href="#"
              class="js-wallet group flex h-10 px-6 items-center justify-center rounded-full border border-transparent font-display bg-accent text-white transition-colors hover:bg-white hover:text-accent hover:border-jacarta-100 dark:border-transparent dark:bg-white/[.15] dark:hover:bg-accent"
              aria-label="connect"
            >
              Connect
            </a>
